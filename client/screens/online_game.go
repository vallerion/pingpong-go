...
func CreateOnlineGameScreen(fontType *opentype.Font, audioContext *audio.Context) *OnlineGameScreen {
...
func (s *OnlineGameScreen) addBall() {
	s.balls = append(s.balls, entities.CreateBall())
}

func (s *OnlineGameScreen) Start() {
	s.themeAudioPlayer.Rewind()
	s.themeAudioPlayer.Play()
}

func (s *OnlineGameScreen) End() {
	s.themeAudioPlayer.Close()
}

func (s *OnlineGameScreen) Update() error {
...
func (s *OnlineGameScreen) Draw(image *ebiten.Image) {
...
func (s *OnlineGameScreen) drawPause(image *ebiten.Image) {
	t := "Pause"
